  ...
  return (
    <Card style={styles.card}>
      <View style={styles.header}>
        <Text style={styles.title}>Voz da Corujinha 🦉</Text>
      ...
      {!loading && !hasAnyPortuguese && (
        <View style={styles.warningBox}>
          ...
          <Text style={styles.warningBody}>
            Seu celular não tem voz em português. Sem isso, a Corujinha vai usar
      ...
      {!loading && hasAnyPortuguese && !hasBrazilian && (
        <View style={styles.warningBox}>
          ...
          <Text style={styles.warningBody}>
            Pra ouvir a Corujinha em português brasileiro, instale as vozes
